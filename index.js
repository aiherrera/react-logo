...
var Logo = function (_a) {
    var logoSVG = _a.logoSVG, width = _a.width, height = _a.height, className = _a.className;
    return (r__default['default'].createElement(Container, { "data-testid": 'Logo', className: className, width: width, height: height },
        r__default['default'].createElement("img", { src: logoSVG, alt: 'Logo' })));
};
